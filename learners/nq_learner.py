...
class NQLearner:
    ...
    def train(self, batch: EpisodeBatch, t_env: int, episode_num: int, per_weight=None):
        ...
        mac_out = th.stack(mac_out, dim=1)  # Concat over time 维度：torch.Size([128, 61, 3, 9])，128为batch_size，61为episode的长度，3智能体数量，9是动作价值函数的维度。
        ...
        if t_env - self.log_stats_t >= self.args.learner_log_interval:
            ...
            print('cuda number: {}, env name: {}, algorithm: {}'.format(self.args.cuda_num, self.args.env_args['map_name'], self.args.name))
