...
from .gire_learner import NGireQLearner
from .gire_vdn_learner import NGireVDNQLearner

from .snc_learner import NSNCQLearner
...
REGISTRY["gire_learner"] = NGireQLearner
REGISTRY["gire_vdn_learner"] = NGireVDNQLearner

REGISTRY["snc_learner"] = NSNCQLearner