...
from modules.agents.herl_agent import PolicyAppModule
...
class BasicHerlMAC:
    ...
    def _build_agents(self, input_shape):
        ...
        self.policy_app = PolicyAppModule(input_shape, self.args)
        print('herl agent module Size: ')  # add
        print(get_parameters_num(self.agent.parameters()))  # add
        print('policy approximate module Size: ')  # add
        print(get_parameters_num(self.policy_app.parameters()))  # add
